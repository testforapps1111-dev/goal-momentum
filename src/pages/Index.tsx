...
import { ChevronDown, BarChart3, History } from 'lucide-react';
...
export default function Index() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setGlowCard(false);
      // Reset to defaults after "Entry Saved" shows
  ...
  return (
    <div className="min-h-screen py-10 px-4 md:px-8">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            ...
            <div className="space-y-10">
              <MomentumSlider label={t('slider.drive')} icon="🔥" value={todayEntry.drive} onChange={v => updateToday({ drive: v })} />
        ...
        <motion.button
          type="button"
          className="glass-card w-full p-6 flex items-center justify-between cursor-pointer"
