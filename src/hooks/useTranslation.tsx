...
const EN_STRINGS: Record<string, string> = {
  ...
  'slider.momentum': 'Momentum',
  'slider.energy': 'Energy',
  'slider.focus': 'Focus',
  'slider.clarity': 'Clarity',
  'slider.impact': 'Impact Level',
  'action.label': 'Took a meaningful step today towards your goal?',
  ...
  'save.save': "Save Today's Entry",
  'save.update': "Update Today's Entry",
  'save.saved': 'Saved',
  ...
  'insights.days': 'days with action taken.',
  'insights.multiplier.pre': 'Momentum increases',
